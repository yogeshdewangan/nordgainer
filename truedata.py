...
def get_price_list_for_back_test(symbol):
    ...
    year = int(temp_date[2])
    price_list = []
    hist_data_1 = td_app.get_historic_data(symbol, bar_size="1 min", start_time=datetime(year, month, day, 9, 15), end_time=datetime(year, month, day, 15, 10))  # remove duration for current date
